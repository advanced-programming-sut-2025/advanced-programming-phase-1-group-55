...
public class FishingController {
    ...
    public void handleButtonClicked(float delta) {
        ...
        handleFishMovement(top, bottom);
    }
    public  void handleFishMovement(float top, float bottom) {
       view.getFishRect().setY(Math.max(bottom, Math.min(top, view.getFishRect().getY()+fishMovementPattern.getNextDeltaY())));
