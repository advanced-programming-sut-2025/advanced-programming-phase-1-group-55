...
public enum ForagingSeed implements Seed {
    BLUE_JAZZ_SEEDS("Jazz Seeds", "Spring"),
    ...
    BOK_CHOYS_SEEDS("Bok Choy Seeds", "Fall"),
    ...
    FORAGING_SEEDS("Foraging Seeds", "Special");

    private final String name;
    private final String season;

    ForagingSeed(String name, String season) {
        this.name = name;
        this.season = season;
    }
